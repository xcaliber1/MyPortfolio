    ...
    <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
        ...
        >
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, enim. Id sed repellendus, ea fugiat temporibus error commodi velit, molestias molestiae veritatis voluptate nulla laudantium? Atque quasi consequatur perspiciatis. Deleniti!
                </p>
            </div>
            <div class="flex flex-col lg:flex-row lg:gap-x-8">
                <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-accent font-normal">Email me at andrewferrer37@gmail.com.</p>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div class="text-accent
                        ...
                        <div>
                            ...
                            <P class="mb-1 text-paragraph">Nagcarlan, Laguna.</P>
                ...
                <form @submit.prevent="submit" class="space-y-8 w-full max-w-md">
                    ...
                    <span v-if="form.errors.email" class="text-sm m-2 text-red-400">{{ form.errors.body }}</span>
